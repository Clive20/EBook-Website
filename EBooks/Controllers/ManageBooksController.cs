...
using EBooks.Filters.AdminSessionFilter;
using EBooks.Models;
...
namespace EBooks.Controllers
{
    ...
    public class ManageBooksController : Controller
    {
        ...
        public ManageBooksController(EBooksContext context, IWebHostEnvironment hostEnvironment)
        {
            _context = context;
        ...
        {
            //also if admin delete book, image will also be delted for specific book
            var book = await _context.Books.FindAsync(id);
            string wwwRootPath = _hostEnvironment.WebRootPath;
            var deleteImagepath = Path.Combine(_hostEnvironment.ContentRootPath, wwwRootPath + "/images/uploads/bookImages/", book.BookImage);
